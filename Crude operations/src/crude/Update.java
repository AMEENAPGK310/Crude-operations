...
public class Update {
	...
	public void updateData() throws ClassNotFoundException, SQLException {
		...
		PreparedStatement ps = (PreparedStatement) con.getConnection().prepareStatement(
				"update student set Name=?,reg_no=?,Department=?,Year=?,Address=?,Username=?,Password=?where Reg_no=?");// delete
																														// statement
